<?php if(!class_exists('Rain\Tpl')){exit;}?> <div class="footer-top-area">
    ...
    <!-- jQuery sticky menu -->
    <script src="/res/site//res/site//res/site/js/owl.carousel.min.js"></script>
    <script src="/res/site//res/site/js/jquery.sticky.js"></script>
    ...
    <!-- Slider -->
    <script type="text/javascript" src="/res/site//res/site/js/bxslider.min.js"></script>
